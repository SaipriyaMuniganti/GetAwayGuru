...
export class DataService {
  private packages: {
    ...
    'Kerala': {
      affordable: [
        { name: 'Serene Munnar Retreat', description: '3 days, 4 nights in the picturesque Munnar', price: 6000, image: '../assets/Get Away Guru/kerala/k1.jpg' },
    ...
    'Ooty': {
      affordable: [
        { name: 'Scenic Ooty Escape', image: '../assets/Get Away Guru/ooty/af1.jpg', description: 'Explore the scenic beauty of Ooty with a 3-day, 2-night package', price: 16000 },
      ...
      luxury: [
        ...
        { name: 'Serene Ooty Luxury', image: '../assets/Get Away Guru/ooty/lux4.jpg', description: 'A serene luxury experience in Ooty for 6 days and 5 nights', price: 20000 },
    ...
    'Coorg': {
      affordable: [
        ...
        { name: 'Coorg Wilderness Adventure', image: '../assets/Get Away Guru/coorg/af4.jpg', description: 'An adventurous escape in the wilderness of Coorg for 6 days and 5 nights', price: 20000 },
      ...
      luxury: [
        ...
        { name: 'Grand Coorg Mansion', image: '../assets/Get Away Guru/coorg/lux5.jpg', description: 'A grand mansion experience in Coorg for 7 days and 6 nights', price: 40000 },
      ],
      coupleFriendly: [
    ...
    'Ladakh': {
      affordable: [
        ...
        { name: 'Ladakh Nature Retreat', image: '../assets/Get Away Guru/ladakh/af3.jpg', description: 'Experience nature\'s retreat in Ladakh for 6 days and 5 nights', price: 16000 },
      ...
      coupleFriendly: [
        ...
        { name: 'Enchanting Ladakh Love', image: '../assets/Get Away Guru/ladakh/cf4.jpg', description: 'Experience enchanting love in Ladakh for 6 days and 5 nights', price: 40000 },
    ...
    'Kullu Manali': {
      affordable: [
        ...
        { name: 'Kullu Manali Serenity Getaway', image: '../assets/Get Away Guru/manali/af4.jpg', description: 'A serene getaway in Kullu Manali for 7 days and 6 nights', price: 21000 },
      ...
      coupleFriendly: [
        { name: 'Romantic Kullu Manali Getaway', image: '../assets/Get Away Guru/manali/cf1.jpg', description: 'A romantic getaway in Kullu Manali for 3 days and 2 nights', price: 30000 },
    ...
    'Kashmir': {
      affordable: [
        ...
        { name: 'Kashmir Cultural Retreat', image: '../assets/Get Away Guru/kashmir/af3.jpg', description: 'Experience cultural retreat in Kashmir for 6 days and 5 nights', price: 16000 },
    ...
    'Araku Valley': {
      affordable: [
        ...
        { name: 'Araku Valley Serene Getaway', image: '../assets/Get Away Guru/araku/af4.jpg', description: 'A serene getaway in Araku Valley for 6 days and 5 nights', price: 11000 },
      ...
      coupleFriendly: [
        { name: 'Romantic Araku Valley Getaway', image: '../assets/Get Away Guru/araku/cf1.jpg', description: 'A romantic getaway in Araku Valley for 2 days and 1 night', price: 15000 },
    ...
    'Italy': {
      affordable: [
        ...
        { name: 'Budget Amalfi Coast Retreat', image: '../assets/Get Away Guru/italy/af3.jpg', description: 'Budget retreat to the Amalfi Coast for 5 days and 4 nights', price: 18000 },
    ...
    'Japan': {
      affordable: [
        ...
        { name: 'Kyoto Budget Cultural Retreat', image: '../assets/Get Away Guru/japan/af3.jpg', description: 'Budget cultural retreat in Kyoto for 5 days and 4 nights', price: 20000 },
      ...
      coupleFriendly: [
        ...
        { name: 'Hokkaido Winter Love Retreat', image: '../assets/Get Away Guru/japan/cf5.jpg', description: 'Winter love retreat in Hokkaido for 6 days and 5 nights', price: 50000 },
      ],
    },
    ...
    'Sri Lanka': {
      ...
      coupleFriendly: [
        { name: 'Romantic Colombo Getaway', image: '../assets/Get Away Guru/srilanka/cf1.jpg', description: 'Romantic getaway in Colombo for 2 days and 1 night', price: 30000 },
    ...
    'Thailand': {
      affordable: [
        ...
        { name: 'Phuket Budget Beach Retreat', image: '../assets/Get Away Guru/thailand/af3.jpg', description: 'Budget beach retreat in Phuket for 6 days and 5 nights', price: 20000 },
      ...
      coupleFriendly: [
        { name: 'Romantic Bangkok Getaway', image: '../assets/Get Away Guru/thailand/cf1.jpg', description: 'Romantic getaway in Bangkok for 3 days and 2 nights', price: 30000 },
    ...
    'France': {
      ...
      coupleFriendly: [
        { name: 'Romantic Parisian Getaway', image: '../assets/Get Away Guru/france/cf1.jpg', description: 'Romantic getaway in Paris for 3 days and 2 nights', price: 40000 },
    ...
    'Maldives': {
      ...
      coupleFriendly: [
        { name: 'Romantic Sunset Cruise', image: '../assets/Get Away Guru/maldives/cf1.jpg', description: 'Romantic sunset cruise for two for 3 days and 2 nights', price: 60000 },
    ...
    'Dubai': {
      ...
      coupleFriendly: [
        { name: 'Romantic Desert Getaway', image: '../assets/Get Away Guru/dubai/cf1.jpg', description: 'Romantic getaway in the Dubai desert for 3 days and 2 nights', price: 60000 },
    ...
    'Switzerland': {
      affordable: [
        ...
        { name: 'Charming Swiss Villages Exploration', image: '../assets/Get Away Guru/switzerland/af3.jpg', description: 'Explore charming Swiss villages on a budget for 6 days and 5 nights', price: 45000 },
